...
@section('NavU', 'side-menu--active')

@section('breadcrumb')
<li class="breadcrumb-item text-sm text-dark active" aria-current="page"><a href="{{ url('/admin/users')}}">Users</a></li>
            ...
            <div class="box">
                <div
                    ...
                    <div class="lg:ml-2 lg:mr-auto text-center lg:text-left mt-3 lg:mt-0">
                        ...
                        <div class="text-slate-500 text-xs mt-0.5">{{$user->area}}</div>
                        <div class="text-slate-500 text-xs mt-0.5">negocio</div>
                ...
                <div class="flex flex-wrap lg:flex-nowrap items-center justify-center p-5">
                    <a class="btn btn-primary py-1 px-2 mr-2" href="{{url('/admin/user/'.$user->id.'/edit')}}">Edit</a>
                    <a class="btn btn-outline-secondary py-1 px-2" href="{{url('/admin/user/'.$user->id.'/delete')}}">Delete</a>
                </div>
            </div>
        </div>
        @endforeach
